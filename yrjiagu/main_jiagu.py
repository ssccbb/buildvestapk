import constants
import yrjiagu.utils.CacheUtil
from yrjiagu.JGApplication import JGApplication

if __name__ == '__main__':
    # cache_util.save_value_to_cache("signature_content","--ks-key-alias yeyan --ks-pass pass:yeyan123 --key-pass  pass:yeyan123")

    cache_util = yrjiagu.utils.CacheUtil.CacheUtil("jiagu_apk_info", "main_jiagu.ini")
